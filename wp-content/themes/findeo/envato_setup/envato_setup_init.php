				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => __( 'Upgrade', 'findeo' ),
							'description' => __( 'Upgrade Content and Settings', 'findeo' ),
							'pending' => __( 'Pending.', 'findeo' ),
							'installing' => __( 'Installing Updates.', 'findeo' ),
							'success' => __( 'Success.', 'findeo' ),
