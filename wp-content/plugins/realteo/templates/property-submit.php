...
<form action="<?php  echo esc_url( $data->action ); ?>" method="post" id="submit-property-form" class="property-manager-form" enctype="multipart/form-data">
	...
	<p>
		...
		<div class="input-with-icon margin-bottom-30 big"><i class="sl sl-icon-arrow-right-circle" style="margin-top: 1px;"></i><input type="submit" name="submit_property" class="button" value="<?php echo esc_attr( $data->submit_button_text ); ?>" /></div>
	</p>
