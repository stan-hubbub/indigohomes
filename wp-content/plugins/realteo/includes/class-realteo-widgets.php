			...
			<div class="agent-title">
				...
				<div class="agent-details">
					<?php  $agent_data = get_userdata( $agentID ); ?>
						<h4>
							<a href="<?php echo esc_url(get_author_posts_url( $agentID )); ?>">
								<?php echo $agent_data->first_name; ?> <?php echo $agent_data->last_name; ?>
							</a>
						</h4>
					<?php 
						...
						<?php 
							if(isset($instance['phone']) && !empty($instance['phone'])) { 
								if(isset($agent_data->phone) && !empty($agent_data->phone)): ?>
									<span>
										<i class="sl sl-icon-call-in"></i>
										<a href="tel:<?php echo esc_html($agent_data->phone); ?>">
